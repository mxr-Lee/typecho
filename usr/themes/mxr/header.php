      ...
      <section class="section-sidebar">
        <div class="sidebar-header">
          <a href="<?php $this->options->siteUrl(); ?>" class="sidebar-header-logo">
            <img class="logo" alt="<?php $this->options->title() ?>" src="<?php $this->options->themeUrl('mxr.png'); ?>" />
          </a>
        ...
        <li class="nav-"><a href="https://mxr-lee.github.io/">JKD</a></li>
        <li class="nav-"><a href="https://www.mxr-lee.top/">MXR</a></li>
        </ul>
        </div>
